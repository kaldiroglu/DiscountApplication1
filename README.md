This the implementation of the case given in the original at Hexagonal architecture the original 2005
...
paper, which are not
complete. For example code has repository package for RateRepository and MockRateRepository, which is kind of against
what is presented in the paper. MockRepository should be outside the hexagon. Or we don't know the package of the test
so I created test package for TestDiscounter.